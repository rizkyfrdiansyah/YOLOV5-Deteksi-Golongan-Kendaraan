# -*- coding: utf-8 -*-
"""Copy of Copy of footbal OBJECT DETECTION

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1in_uaim5_bf85e8ZCGUYlVjCL4vKzHuz
...
# %%time
# %cd /content/yolov5/
# !python train.py --img 416 --batch 64 --epochs 200 --data {dataset.location}/data.yaml --cfg ./models/custom_yolov5s.yaml --weights '' --name yolov5s_results  --cache
