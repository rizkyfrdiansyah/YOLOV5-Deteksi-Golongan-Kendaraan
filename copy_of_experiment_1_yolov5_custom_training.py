# -*- coding: utf-8 -*-
"""Copy of Experiment 1 YOLOv5-Custom-Training.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Rho2na7x74JK61VYx3OLRowZ294xhbzP
...
project = rf.workspace("muhammad-rizky-ferdiansyah-00fow").project("golongan-kendaraan-tol-v2")
...
!python train.py --img 416 --batch 32 --epochs 200 --data {dataset.location}/data.yaml --weights yolov5s.pt --cache
